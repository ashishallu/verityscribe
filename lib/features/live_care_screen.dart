  ...
  Widget build(BuildContext context) {
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    Container(
                        ...
                        decoration: const BoxDecoration(
                            color: Color(0xFFDDF7EC), shape: BoxShape.circle),
                        child: const Icon(Icons.check_rounded,
                            size: 52, color: Color(0xFF11845B))),
                    ...
                    Text(
                        'Your appointment with ${doctor?.name ?? 'your doctor'} is confirmed for ${date!.toLocal().toString().split(' ').first} at ${time!.format(context)}.',
    ...
    return Scaffold(
        ...
        body: ListView(
            ...
            children: [
              const Text('Find your care team',
                  style: TextStyle(fontSize: 26, fontWeight: FontWeight.w800)),
              const SizedBox(height: 6),
              const Text('Choose a hospital, specialist and convenient time.',
                  ...
                  child: Column(
                    ...
                    DropdownButtonFormField<DoctorDirectoryItem>(
                        ...
                        items: filtered
                            .map((x) => DropdownMenuItem(
                                value: x,
                                child: Text('${x.name} • ${x.specialization}')))
                            .toList(),
                        onChanged: (x) => setState(() => doctor = x),
                        decoration: const InputDecoration(
                            hintText: 'Select available doctor',
                              ...
                              child: Column(children: [
                                ...
                                Expanded(
                                    child: CupertinoDatePicker(
                                        ...
                                        onDateTimeChanged: (value) => selected =
              ...
              _BookingCard(
                ...
                TextField(
                    ...
                    decoration: const InputDecoration(
                        labelText: 'Notes',
                        hintText: 'Anything else the doctor should know?',
...
class _FieldTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
      ...
      child: Text(text,
          style: const TextStyle(
              fontWeight: FontWeight.w700, color: Color(0xFF24324A))));
}
...
class _BookingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Color(0x120D1B3E), blurRadius: 18, offset: Offset(0, 8))
          ]),
      child: child);
}
